...
func WithTimeSource(timeSource TimeSource) Option { _ = "STUB: not implemented"; return *new(Option) }
...
func WithTimeSkewLimit(skew time.Duration) Option { _ = "STUB: not implemented"; return *new(Option) }
...
func WithMetadataSizeLimit(size int) Option { _ = "STUB: not implemented"; return *new(Option) }

// WithIntegrityCheck enables or disables Content-MD5 validation when
// putting an Object.
func WithIntegrityCheck(check bool) Option { _ = "STUB: not implemented"; return *new(Option) }
...
func WithGlobalLog() Option { _ = "STUB: not implemented"; return *new(Option) }

// WithRequestID sets the starting ID used to generate the "x-amz-request-id"
// header.
func WithRequestID(id uint64) Option { _ = "STUB: not implemented"; return *new(Option) }
...
func WithHostBucket(enabled bool) Option { _ = "STUB: not implemented"; return *new(Option) }
...
//
// See https://docs.aws.amazon.com/AmazonS3/latest/dev/UsingBucket.html for details.
func WithHostBucketBase(hosts ...string) Option { _ = "STUB: not implemented"; return *new(Option) }

// WithoutVersioning disables versioning on the passed backend, if it supported it.
func WithoutVersioning() Option { _ = "STUB: not implemented"; return *new(Option) }
...
func WithUnimplementedPageError() Option { _ = "STUB: not implemented"; return *new(Option) }

// WithAutoBucket instructs GoFakeS3 to create buckets that don't exist on first use,
// rather than returning ErrNoSuchBucket.
func WithAutoBucket(enabled bool) Option { _ = "STUB: not implemented"; return *new(Option) }

// WithInsecureCORS responds with * for all Access-Control-Allow headers.
func WithInsecureCORS() Option { _ = "STUB: not implemented"; return *new(Option) }
